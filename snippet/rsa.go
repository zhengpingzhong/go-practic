...
func main() {
	data, _ := RsaEncrypt([]byte("18879703324"))
	fmt.Println("加密：\n" + base64.StdEncoding.EncodeToString(data))

	cipherText, err := base64.StdEncoding.DecodeString("")
	if err != nil {
		panic(nil)
	}
	origData, _ := RsaDecrypt(cipherText)
	fmt.Println("解密：\n" + string(origData))
}
